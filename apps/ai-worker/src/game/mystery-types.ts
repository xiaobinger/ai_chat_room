  ...
  // ========== 剧本 1：古宅疑云 ==========
  {
    ...
    characters: [
      ...
      },
      {
        ...
        objective: '确保遗嘱按委托人意愿执行，不卷入家族纷争。',
  ...
  // ========== 剧本 2：游轮迷案 ==========
  {
    ...
    characters: [
      ...
      },
      {
        ...
        objective: '保护自己和船员，不要让游轮事故的事被公开。',
    ...
    characters: [
      {
        ...
        objective: '保住自己的新剧，不让林首席离开的消息影响票房。',
  ...
  // ========== 剧本 5：列车谋杀 ==========
  {
    ...
    characters: [
      ...
      },
      {
        ...
        objective: '让金先生认她这个女儿，否则她什么都得不到。',
      ...
      },
      {
        ...
        objective: '让金先生为当年的事付出代价，但要做得不留痕迹。',
    ...
    characters: [
      {
        ...
        objective: '拿到研究成果，不要让李博士的反对影响公司上市。',
      ...
      },
      {
        ...
        objective: '保护李博士的研究成果，同时保全自己的工作。',
